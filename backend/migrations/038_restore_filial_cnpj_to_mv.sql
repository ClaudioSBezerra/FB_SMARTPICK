-- Migration: Restore columns dropped in 036 (filial_cnpj, origem, tipo_operacao) and keep company_id
-- Fixes "column mv.filial_cnpj does not exist" error in reports
