-- =====================================================
-- GERA_XMLS_NFSE_SAIDAS_SALVADOR.SQL  (v1 - PL/SQL Developer Command Window)
-- Gera um arquivo .xml por NFS-e em C:\TEMP
-- Formato ABRASF (Salvador/BA) - XML sem declaracao <?xml?>
-- Adiciona declaracao windows-1252 antes do conteudo
-- Uso: @C:\TEMP\gera_xmls_nfse_saidas_salvador.sql
-- =====================================================
...
-- -------------------------------------------------------
SPOOL C:\TEMP\_driver_xmls_nfse_salvador.sql
...
BEGIN
    ...
    FOR rec IN (
        ...
        -- Formato ABRASF nao tem declaracao <?xml?> no conteudo:
        -- emite a declaracao via PROMPT antes do SELECT
        DBMS_OUTPUT.PUT_LINE('PROMPT <?xml version="1.0" encoding="windows-1252"?>');
        DBMS_OUTPUT.PUT_LINE(
            'SELECT xml_nfse FROM sfc_nfse' ||
...
@C:\TEMP\_driver_xmls_nfse_salvador.sql
